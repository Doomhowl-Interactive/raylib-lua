...
static GlyphInfo LuaGetArgument_CharInfo(lua_State* L, int index)
{
    GlyphInfo result = { 0 };
    index = lua_absindex(L, index); // Makes sure we use absolute indices because we push multiple values
    ...
    // luaL_argcheck(L, lua_getfield(L, index, "image") == LUA_TNUMBER, index, "Expected GlyphInfo.advanceX");
...
static RayCollision LuaGetArgument_RayHitInfo(lua_State* L, int index)
{
...
void LuaPush_BoundingBox(lua_State* L, BoundingBox bb)
{
    lua_createtable(L, 0, 2);
...
int lua_DrawRectangleRoundedLines()
{
    Rectangle rec = LuaGetArgument_Rectangle(L, 1);
    float roundness = LuaGetArgument_float(L, 2);
    int segments = LuaGetArgument_int(L, 3);
...
int lua_DrawRectangleRoundedLinesEx()
{
    Rectangle rec = LuaGetArgument_Rectangle(L, 1);
    float roundness = LuaGetArgument_float(L, 2);
    int segments = LuaGetArgument_int(L, 3);
...
//----------------------------------------------------------------------------------
int lua_Vector3Zero(lua_State* L)
{
...
int lua_Vector3One(lua_State* L)
{
...
int lua_Vector3Add(lua_State* L)
{
    Vector3 arg1 = LuaGetArgument_Vector3(L, 1);
...
int lua_Vector3Subtract(lua_State* L)
{
    Vector3 arg1 = LuaGetArgument_Vector3(L, 1);
    Vector3 arg2 = LuaGetArgument_Vector3(L, 2);
...
int lua_Vector3CrossProduct(lua_State* L)
{
    Vector3 arg1 = LuaGetArgument_Vector3(L, 1);
    Vector3 arg2 = LuaGetArgument_Vector3(L, 2);
...
int lua_Vector3Perpendicular(lua_State* L)
{
    Vector3 arg1 = LuaGetArgument_Vector3(L, 1);
...
int lua_Vector3DotProduct(lua_State* L)
{
    Vector3 arg1 = LuaGetArgument_Vector3(L, 1);
    Vector3 arg2 = LuaGetArgument_Vector3(L, 2);
...
int lua_Vector3Length(lua_State* L)
{
...
int lua_Vector3Scale(lua_State* L)
{
    Vector3 arg1 = LuaGetArgument_Vector3(L, 1);
    float arg2 = LuaGetArgument_float(L, 2);
...
int lua_Vector3Negate(lua_State* L)
{
    Vector3 arg1 = LuaGetArgument_Vector3(L, 1);
    Vector3Negate(arg1);
    LuaPush_Vector3(L, arg1);
...
int lua_Vector3Normalize(lua_State* L)
{
    Vector3 arg1 = LuaGetArgument_Vector3(L, 1);
...
int lua_Vector3Distance(lua_State* L)
{
    Vector3 arg1 = LuaGetArgument_Vector3(L, 1);
    Vector3 arg2 = LuaGetArgument_Vector3(L, 2);
...
int lua_Vector3Lerp(lua_State* L)
{
    Vector3 arg1 = LuaGetArgument_Vector3(L, 1);
    Vector3 arg2 = LuaGetArgument_Vector3(L, 2);
    float arg3 = LuaGetArgument_float(L, 3);
...
int lua_Vector3Reflect(lua_State* L)
{
    Vector3 arg1 = LuaGetArgument_Vector3(L, 1);
    Vector3 arg2 = LuaGetArgument_Vector3(L, 2);
...
int lua_Vector3Transform(lua_State* L)
{
    Vector3 arg1 = LuaGetArgument_Vector3(L, 1);
...
int lua_MatrixSubtract(lua_State* L)
{
    Matrix arg1 = LuaGetArgument_Matrix(L, 1);
    Matrix arg2 = LuaGetArgument_Matrix(L, 2);
